...
export class App {
  ...
  mapConfig(config) {
    return config.map([ // There is no way to refactor this that I can tell
      ...
      { route: 'mountains',
        name: 'mountains',
        moduleId: PLATFORM.moduleName('./mountains'),
        nav: false,
        mountainstitle: 'Mountain Climbs',
        settings: 'fa fa-users' },
      { route: 'safaris', name: 'safaris', moduleId: PLATFORM.moduleName('./safaris'), nav: false, title: 'Safaris', settings: 'fa fa-users' },
      { route: 'beaches',
        name: 'beaches',
        moduleId: PLATFORM.moduleName('./beaches'),
        nav: false,
        title: 'Beaches Holidays',
        settings: 'fa fa-users' },
      { route: 'day-trips',
        name: 'day-trips',
        moduleId: PLATFORM.moduleName('./day-trips'),
        nav: false,
        title: 'Day Trips',
        settings: 'fa fa-users' },
      { route: 'testimonials',
